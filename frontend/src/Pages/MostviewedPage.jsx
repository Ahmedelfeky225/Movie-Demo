...
import { MostviewedFilm } from '../MostviewedFilm';
...
const MostviewedPage = () => {
    ...
    useEffect(() => {
        fetch('http://localhost:8080/movies/mostviews/desc?page=1&limit=12')
  ...
  return (
    <>
<MostviewedFilm limit={12} page={pageN.page} totalPages={pageN.totalPages}/>
<div>
